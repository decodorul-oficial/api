-- =====================================================
-- MIGRAȚIA 041: CORECTAREA FUNCȚIEI DE STATISTICI EXTERNE
-- =====================================================
...
COMMENT ON FUNCTION public.get_external_documents_stats() IS 'Obține statistici despre documentele externe menționate (corectat)';
