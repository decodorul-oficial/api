-- =====================================================
-- MIGRAȚIA 042: CORECTAREA DEFINITIVĂ A FUNCȚIEI DE STATISTICI
-- =====================================================
-- Corectează definitiv funcția de statistici pentru documentele externe
...
COMMENT ON FUNCTION public.get_external_documents_stats() IS 'Obține statistici despre documentele externe menționate (corectat definitiv)';
