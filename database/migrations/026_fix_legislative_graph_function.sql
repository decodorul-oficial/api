-- =====================================================
-- MIGRAȚIA 026: CORECTAREA FUNCȚIEI GET_LEGISLATIVE_GRAPH
-- =====================================================
-- Corectează eroarea din funcția get_legislative_graph unde v_nodes era folosit în loc de v_links
...
BEGIN
    ...
    -- Construiește lista de conexiuni (CORECTAT: folosește v_links în loc de v_nodes)
    SELECT jsonb_agg(
        jsonb_build_object(
...
COMMENT ON FUNCTION public.get_legislative_graph(BIGINT, INT) IS 'Returnează graficul de conexiuni legislative pentru un document dat (corectat)';
